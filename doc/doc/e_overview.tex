...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[node distance=4.7cm]
        ...
        \draw[very thick, ->, red]  (supply.base east) -| ++(1.7cm, 0)     |- node[below right] {48\si{\volt}} (step-drv.base west);
        \draw[very thick, ->, red]  (supply.base east) -| ++(1.7cm, 0)     |- node[below right] {48\si{\volt}} (bldc-drv.base west);
        \draw[very thick, ->, red]  (supply.east) -| ++(1.2cm, 0)     |- node[below right] {24\si{\volt}} (dc-drv.base west);
    \end{tikzpicture}
