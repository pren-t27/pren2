...
Startsignal im \mbox{Startbereich \tikz{\draw[fill=yellow] (0,0) rectangle 
(0.25,0.25);}} und darf die, in der Aufgabenstellung definierten, Abmessungen 
nicht überschreiten. Nach dem Startsignal darf sich der Roboter innerhalb von 
\mbox{Start- \tikz{\draw[fill=yellow] (0,0) rectangle (0.25,0.25);}} und 
\mbox{Bewegungsbereich \tikz{\draw[fill=cyan] (0,0) rectangle (0.25,0.25);}} 
bewegen. Der \mbox{verbotene Bereich \tikz{\draw[fill=red] (0,0) rectangle 
(0.25,0.25);}} darf jedoch weder berührt noch überragt werden. Im 
\mbox{Zielbereich \tikz{\draw[fill=green] (0,0) rectangle (0.25,0.25);}} 
